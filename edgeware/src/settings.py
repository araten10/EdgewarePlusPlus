...
class Settings:
    ...
    def load_settings(self) -> None:
        ...
        self.subliminal_caption_mood = bool(self.config["capPopMood"])  # TODO: What to do with this?
        ...
        self.notification_mood = bool(self.config["notificationMood"])  # TODO: What to do with this?
