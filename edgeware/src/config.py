...
#FILE_TEXT: there is some useful stuff in here, but it's also information i'm not sure people really need to know. I don't know if people care about what a unique id is or how it works. also, i've been thinking about splitting up the file tab and moving things around, as it has a lot of important stuff in it mixed in with things barely anyone will ever use.
