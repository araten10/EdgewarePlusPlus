...
def _request_global_panic_key_non_darwin(button: Button, var: StringVar) -> None:
    """Non-macOS implementation using pynput subprocess."""
    window = KeyListenerWindow()
...
def request_global_panic_key(button: Button, var: StringVar) -> None:
    """Non-macOS: capture a global panic key via pynput subprocess."""
    _request_global_panic_key_non_darwin(button, var)
